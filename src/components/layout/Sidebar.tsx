...
const navigation = {
  admin: [
    ...
    { name: 'Quản lý bệnh nhân', href: '/patients', icon: Users },
    { name: 'Quản lý bác sĩ', href: '/doctors', icon: Stethoscope },
    { name: 'Lịch hẹn', href: '/appointments', icon: Calendar },
    { name: 'Hồ sơ y tế', href: '/records', icon: FileText },
    { name: 'Thông báo', href: '/notifications', icon: Bell },
    { name: 'Cài đặt', href: '/settings', icon: Settings },
  ],
  doctor: [
    { name: 'Dashboard', href: '/dashboard', icon: BarChart3 },
    { name: 'Bệnh nhân của tôi', href: '/my-patients', icon: Users },
    { name: 'Lịch hẹn', href: '/appointments', icon: Calendar },
    { name: 'Khám bệnh', href: '/visits', icon: ClipboardList },
    { name: 'Hồ sơ y tế', href: '/records', icon: FileText },
    { name: 'Thông báo', href: '/notifications', icon: Bell },
  ],
  patient: [
    ...
    { name: 'Hồ sơ y tế', href: '/my-records', icon: FileText },
